...
template <typename T>
std::unique_ptr<RWTestBase> makeTest(T val, H5::PredType type, const std::array<uint8_t, sizeof(T)> &bytes)
{
...
std::vector<std::unique_ptr<RWTestBase>> makeTests()
{
    ...
    v.push_back(makeTest<int64_t>(9100520151209, H5::PredType::STD_I64LE, {0xa9, 0x58, 0x45, 0xe1, 0x46, 0x08, 0x00, 0x00}));
    v.push_back(makeTest<int64_t>(-4976301893546, H5::PredType::STD_I64LE, {0x56, 0x18, 0x4b, 0x5d, 0x79, 0xfb, 0xff, 0xff}));
    v.push_back(makeTest<int64_t>(9100520151209, H5::PredType::STD_I64BE, {0x00, 0x00, 0x08, 0x46, 0xe1, 0x45, 0x58, 0xa9}));
    v.push_back(makeTest<int64_t>(-4976301893546, H5::PredType::STD_I64BE, {0xff, 0xff, 0xfb, 0x79, 0x5d, 0x4b, 0x18, 0x56}));
    v.push_back(makeTest<uint64_t>(91439100520151209, H5::PredType::STD_U64LE, {0xa9, 0xb8, 0x15, 0xa1, 0x60, 0xdb, 0x44, 0x01}));
    v.push_back(makeTest<uint64_t>(91439100520151209, H5::PredType::STD_U64BE, {0x01, 0x44, 0xdb, 0x60, 0xa1, 0x15, 0xb8, 0xa9}));
    ...
    v.push_back(makeTest<double>(3199.23342147, H5::PredType::IEEE_F64LE, {0xab, 0xd7, 0x04, 0x83, 0x77, 0xfe, 0xa8, 0x40}));
    v.push_back(makeTest<double>(-938.23716, H5::PredType::IEEE_F64LE, {0x5b, 0x5f, 0x24, 0xb4, 0xe5, 0x51, 0x8d, 0xc0}));
    v.push_back(makeTest<double>(3199.23342147, H5::PredType::IEEE_F64BE, {0x40, 0xa8, 0xfe, 0x77, 0x83, 0x04, 0xd7, 0xab}));
    v.push_back(makeTest<double>(-938.23716, H5::PredType::IEEE_F64BE, {0xc0, 0x8d, 0x51, 0xe5, 0xb4, 0x24, 0x5f, 0x5b}));
