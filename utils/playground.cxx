...
namespace {
    ...
    std::ostream &printRange(
            std::ostream &os, Iterator begin, Iterator end, const std::string &open,
            const std::string &close, const std::string &sep = ", ") {
    ...
    template <std::size_t N> std::ostream &operator<<(std::ostream &os, const std::bitset<N> &bs) {
...
int main() {
    ...
    std::cout << arr1 << std::endl << "+" << std::endl << arr2 << std::endl << "=" << std::endl;
