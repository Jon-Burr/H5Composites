...
namespace H5Composites {
    ...
    bool MergeFactory::contains(TypeRegister::id_t id) const { return m_rules.count(id); }
    ...
    H5Buffer MergeFactory::merge(
            TypeRegister::id_t id, const std::vector<H5Buffer> &buffers) const {
    ...
    void MergeFactory::setMergeRule(
