...
namespace H5Composites {
    ...
    enum class DTypeComparison {
        ...
        LHSMorePrecise, ///< The domain of the LHS data-type contains the domain of the RHS
                        ///< data-type
        RHSMorePrecise, ///< The domain of the RHS data-type contains the domain of the LHS
                        ///< data-type
    ...
    std::map<std::string, long> getEnumValues(
            const H5::EnumType &enumType, std::size_t nameSize = 100);
