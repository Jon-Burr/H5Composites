...
namespace H5Composites {
     ...
     */
    template <typename T> class CompositeDefinition {
    public:
        /**
         ...
         *
         * The buffer is guaranteed to have the correct data type (i.e. that returned by the dtype
         * function)
         */
    ...
    private:
        struct IPiece {
            ...
            virtual void readTo(
                    T &obj, const void *buffer, const H5::CompType &fullDType) const = 0;
            virtual void writeFrom(
                    const T &obj, void *buffer, const H5::CompType &fullDType) const = 0;
        };

        template <typename U> struct Piece : public IPiece {
